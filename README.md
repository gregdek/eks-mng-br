...
[Image: mng-001.png]Note that at the time of writing this,  eksctl creates a cluster with a default Kubernetes version of 1.18; because version 1.19 is already available, you see a link to update the new cluster. Stay with your 1.18 cluster for now.
...
[Image: mng-004.png]Click the “Create” button and your new role will be created. 
...
[Image: mng-new-sg-2.png]Save your new security group.
...
[Image: mng-007.png]Your managed node group is now available to accept workloads. To ensure that your managed node group is running as expected, you can run the following kubectl command from your local workstation:
...
If you have questions, please feel free to join us in our Bottlerocket discussion forum (https://github.com/bottlerocket-os/bottlerocket/discussions), where the Bottlerocket team will be happy to answer any questions you may have. 
